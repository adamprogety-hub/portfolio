...
export default function WebPreview({ isHovered, accent, images }: WebPreviewProps) {
  return (
    <div
      style={{
        width: '100%',
    ...
    >
      ...
      >
        {images && images[2] ? (
          <Image src={images[2]} alt="Screen 3" fill style={{ objectFit: 'cover', objectPosition: 'top center' }} />
        ) : (
      ...
      >
        {images && images[1] ? (
          <Image src={images[1]} alt="Screen 2" fill style={{ objectFit: 'cover', objectPosition: 'top center' }} />
        ) : (
      ...
      >
        ...
        />
        {images && images[0] ? (
          <Image src={images[0]} alt="Screen 1" fill style={{ objectFit: 'cover', objectPosition: 'top left' }} />
        ) : (
          <>
